...
const SvgHiper = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <style>{".hiper_svg__st1{fill:#fff}"}</style>
    <path
      d="M0 0h780v500H0z"
      style={{
        fill: "#f37421",
